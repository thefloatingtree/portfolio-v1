...
export default function About() {
    return (
        <div id="about" className="font-arvo-bold text-prussian-blue space-y-3">
            ...
            <p className="text-md">Hello! My name is Jacob and I love creating things that live in the browser. My interest in web development started in university during a web development class where we learned how to use php and heroku to build and host websites. The ability to create just about anything and share it quickly had me hooked and I haven't stopped building things since. I almost always have a couple personal projects in the works, ask me about them!</p>
